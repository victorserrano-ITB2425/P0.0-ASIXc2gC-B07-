...
- [2. Documentacion de la configuracion del router](#2-Documentacion-de-la-configuracion-del-router)
  -[2.1 Configuración del host y hostname](#2.1Configuración-del-host-y-hostname)
  -[2.2 Configuramos el Netplan](#2.2Configuramos-el-Netplan)
  -[2.3Configuracion del firewall](#2.3Configuracion-del-firewall)
  -[2.4 Instalación del DHCP](#2.4Instalación-del-DHCP)
  -[2.5 Configuracion del DHCP](#2.5Configuracion-del-DHCP)
  -[2.6 Creación del usuario bchecker](#2.6Creación-del-usuario-bchecker)
